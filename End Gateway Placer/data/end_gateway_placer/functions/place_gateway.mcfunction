...
execute as @s unless block ~ ~ ~ #end_gateway_placer:air run tellraw @s {"text": "You can only place this in air.", "color": "red"}
execute as @s unless block ~ ~ ~ #end_gateway_placer:air run tag @s add cant_place_gateway
