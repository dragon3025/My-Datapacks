...
scoreboard players enable @a unset_watchman
scoreboard players enable @a watchman_targets

execute as @a[scores={set_watchman=1..}] at @s run function watchman:set_watchman
execute as @a[scores={unset_watchman=1..}] at @s run function watchman:unset_watchman
