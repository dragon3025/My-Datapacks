...
# Set Frame Fixed
execute as @a[scores={frame_fixed}] at @s anchored eyes positioned ^ ^ ^1 run data merge entity @e[type=#item_frame_ctrl:item_frame,nbt={Fixed:0b, Item:{}}, limit=1, sort=nearest, distance=..4] {Fixed:true}
...
# Set Frame Invisible
execute as @a[scores={frame_invisible}] at @s anchored eyes positioned ^ ^ ^1 run data merge entity @e[type=#item_frame_ctrl:item_frame,nbt={Invisible:0b, Item:{}}, limit=1, sort=nearest, distance=..4] {Invisible:true}
