...
# Show edit particles
execute anchored eyes positioned ^ ^ ^1 as @e[type=#item_frame_ctrl:item_frame, nbt={Invisible:0b, Item:{}}, limit=1, sort=nearest, distance=..4] at @s run particle minecraft:note ~ ~ ~ 0.2 0.2 0.2 1 10 force
