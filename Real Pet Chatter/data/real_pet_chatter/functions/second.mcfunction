...
execute if score admin mobs_anger_cats matches 1.. as @e[type=#real_pet_chatter:friendly] at @s if entity @e[type=#real_pet_chatter:neutral_or_hostile, tag=hostile, tag=!persistent, distance=..4] run tag @s add angry_pet
