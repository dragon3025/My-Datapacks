...
scoreboard players operation @s pet_chatter_cool = @e[type=area_effect_cloud,name="math_random_kcjbc",distance=..1,limit=1] math_input1
scoreboard players operation @s pet_chatter_cool %= @s math_input2
scoreboard players operation @s pet_chatter_cool += @s math_input1
