...
execute if score admin dt_emancity_loot matches 1.. if score admin dt_eman_de_loot matches ..-1 as @a[predicate=drgn_twks:gained_elytra_advancement] at @s run execute as @e[type=enderman, tag=!ender_loot_changed,limit=1, sort=nearest] run data merge entity @s {DeathLootTable:"drgn_twks:enderman_end_city_gear"}
execute if score admin dt_emancity_loot matches 1.. if score admin dt_eman_de_loot matches ..-1 as @a[predicate=drgn_twks:gained_elytra_advancement] at @s run execute as @e[type=enderman, tag=!ender_loot_changed,limit=1, sort=nearest] run tag @s add ender_loot_changed

execute if score admin dt_emancity_loot matches ..-1 if score admin dt_eman_de_loot matches 1.. as @a[predicate=drgn_twks:gained_elytra_advancement] at @s run execute as @e[type=enderman, tag=!ender_loot_changed,limit=1, sort=nearest] run data merge entity @s {DeathLootTable:"drgn_twks:enderman_dragon_egg"}
execute if score admin dt_emancity_loot matches ..-1 if score admin dt_eman_de_loot matches 1.. as @a[predicate=drgn_twks:gained_elytra_advancement] at @s run execute as @e[type=enderman, tag=!ender_loot_changed,limit=1, sort=nearest] run tag @s add ender_loot_changed

# Wither Skeleton Loot Increase
execute if score admin dt_in_w_skl_loot matches 1.. as @a at @s run execute as @e[type=wither_skeleton, tag=!w_skeleton_loot_inc, limit=1, sort=nearest] run data merge entity @s {DeathLootTable:"drgn_twks:wither_skeleton_boosted"}
execute if score admin dt_in_w_skl_loot matches 1.. as @a at @s run execute as @e[type=wither_skeleton, tag=!w_skeleton_loot_inc, limit=1, sort=nearest] run tag @s add w_skeleton_loot_inc
