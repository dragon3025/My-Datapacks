...
execute unless score admin dt_emancity_loot matches -2147483648..2147483647 run scoreboard players set admin dt_emancity_loot 0
execute unless score admin dt_eman_de_loot matches -2147483648..2147483647 run scoreboard players set admin dt_eman_de_loot 0
