...
execute positioned ~-50.5 ~-50.5 ~-50.5 run tag @a[scores={spawn_blocker_detect=40}, dx=100, dy=384, dz=100] add spawn_blocker_detected

#Beam and Visual Box when Finding
execute if entity @a[scores={spawn_blocker_detect=1..}] run particle dust 1 1 1 20 ~ ~ ~ 0.1 384 0.1 1 25 force
execute if entity @a[scores={spawn_blocker_detect=1..}] run particle dust 0.5 1 1 20 ~ ~ ~ 0.1 384 0.1 1 25 force
