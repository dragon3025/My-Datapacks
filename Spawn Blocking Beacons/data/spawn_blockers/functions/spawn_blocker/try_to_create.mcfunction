...
execute as @s[tag=!spawn_blocker_already_there, tag=spawn_blocker_blocks_pass, tag=spawn_blocker_items_pass] run tellraw @p {"text": "Spawn Blocker created.", "color": "yellow"}
