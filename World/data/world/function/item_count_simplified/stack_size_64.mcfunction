scoreboard players operation #calc_double_chest temp = @s item_count_simplified
scoreboard players set @s item_count_simplified 0

scoreboard players set #calc_denominator temp 64
...
execute unless score #calc_stack_remainder temp matches 1 run data merge storage world:data {calc_stack_text:" (x64) stacks, "}
...
execute if score #calc_stack_remainder temp matches 1 run data merge storage world:data {calc_stack_text:" (x64) stack, "}
